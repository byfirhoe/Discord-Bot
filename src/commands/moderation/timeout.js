...
const { permissionsRequired, botPermissions, callback } = require('./kick');
const ms = require('ms');
...
module.exports = {
    ...
    callback: async (client, interaction) => {
        ...
        if (targetUserRolePosition >= botRolePosition) {
            await interaction.editReply("I can't timeout that user because they have the same/higher role than ne.");
            return; 
        }
